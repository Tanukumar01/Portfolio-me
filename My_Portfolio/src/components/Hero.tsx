    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          >
            <p className="text-primary-600 dark:text-primary-400 font-mono mb-4">Hello, my name is Tanu</p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-gray-900 dark:text-white">
              Tanu
            </h1>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-medium mb-6 text-gray-700 dark:text-gray-300">
              Aspiring <span className="text-primary-600 dark:text-primary-400">Software Engineer</span> &<br />
              <span className="text-secondary-600 dark:text-secondary-400">Full Stack Developer</span>
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 mb-8 max-w-2xl">
              I'm a passionate 3rd year B.Tech CSE student focused on creating exceptional 
              digital experiences. Currently exploring Web Development, AI.
            </p>
            
            <div className="flex flex-wrap gap-4">
              <a 
                href="\src\Photos\Tanu-Kumar-resume.pdf" 
        ...
        >
          <ScrollLink to="about" smooth={true} duration={500} className="flex flex-col items-center cursor-pointer">
